...
Once you land there, press `Z — New combo unlocked: warped clean across files, straight back to the exact line you left in this one, no gf or file path needed this time — the mark carries the file along with the position.
